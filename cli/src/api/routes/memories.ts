...
export const memoryRoutes: RouteDefinition[] = [
    ...
    },
    {
        ...
        handle: async ({ params, req, store, json, err }) => {
            ...
            const memory = await store.addMemory(space, body.name, body.content, { tags, tier: body.tier });
    ...
    },
    {
        ...
        handle: async ({ params, req, store, json, err }) => {
            ...
            if (body.content !== undefined) await store.updateMemory(memory.id, { content: body.content });
