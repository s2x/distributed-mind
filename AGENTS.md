...
| Web frontend          | `web/public/*`                        | SPA for browsing and editing spaces and memories, including URL-driven client routing (`routing.js`) for space/view/memory deep links and reload/back-forward restoration.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
